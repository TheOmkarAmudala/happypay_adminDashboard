...
const SlpePaymentModesCards = ({ onSelect, selectedMode }) => {
    ...
    // normalize helper to avoid case / typo issues
    ...
    const getCategoryFromName = (name = "") => {
        ...
        if (lower.includes("tarvel")) return "travel"; // backend typo safety
        return "other";
    };
